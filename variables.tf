...
variable "namespace" {
  type        = string
  description = "Namespace where nginx controller should be deployed"
  default     = "ingres-nginx"
}
...
variable "controller_daemonset_use_hostport" {
  type        = bool
